      ...
      <nav class="flex gap-4 justify-between">
        <div class="flex gap-4 items-center">
          <h2 class="text-xl font-bold">
            ...
            <router-link class="text-green-600" :to="{ name: 'home' }">
              <i>Cuistotutos</i>
            </router-link>
          </h2>
          ...
          <template v-if="auth.check">
            ...
            <RouterLink class="router-link" :to="{ name: 'recettes.create' }">
              Ajouter une recette
            </RouterLink>
          </template>
        </div>
    ...
    <div class="px-4 pt-3 pb-4 border-b -mx-4 border-gray-400">
      <div class="max-w-xl mx-auto">
        <h2 class="text-xl text-left inline-block font-semibold text-gray-800">
          S'incrire a notre newsLetters
        </h2>
        <p class="text-gray-700 text-xs pl-px">
          Les meilleures tutoriels sur internet je n'ai plus d'inspi pour le
          reste.
        </p>
